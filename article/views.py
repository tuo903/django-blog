...
def article_column(request):
    ...
    if request.method =="POST":
        column_name = request.POST['colunm']
...
def edit_article(request, article_id):
    if request.method == "GET":
        ...
        return render(request, 'article/column/edit_article.html', {'article':article, "article_columns":article_columns, 'this_article_form':this_article_form,
